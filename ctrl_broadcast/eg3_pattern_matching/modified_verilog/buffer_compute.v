...
reg [7:0] ap_done_chain;
always @ (posedge ap_clk) begin
    ap_done_chain[0] <= (grp_kmp_fu_988_ap_done == 1'b0) | (grp_kmp_fu_976_ap_done == 1'b0) | (grp_kmp_fu_964_ap_done == 1'b0) | (grp_kmp_fu_952_ap_done == 1'b0) | (grp_kmp_fu_940_ap_done == 1'b0) | (grp_kmp_fu_928_ap_done == 1'b0) | (grp_kmp_fu_916_ap_done == 1'b0) | (grp_kmp_fu_904_ap_done == 1'b0); 
    ap_done_chain[1] <= (grp_kmp_fu_892_ap_done == 1'b0) | (grp_kmp_fu_880_ap_done == 1'b0) | (grp_kmp_fu_868_ap_done == 1'b0) | (grp_kmp_fu_856_ap_done == 1'b0) | (grp_kmp_fu_844_ap_done == 1'b0) | (grp_kmp_fu_832_ap_done == 1'b0) | (grp_kmp_fu_820_ap_done == 1'b0) | (grp_kmp_fu_808_ap_done == 1'b0);
    ap_done_chain[2] <= (grp_kmp_fu_796_ap_done == 1'b0) | (grp_kmp_fu_784_ap_done == 1'b0) | (grp_kmp_fu_772_ap_done == 1'b0) | (grp_kmp_fu_760_ap_done == 1'b0) | (grp_kmp_fu_748_ap_done == 1'b0) | (grp_kmp_fu_736_ap_done == 1'b0) | (grp_kmp_fu_724_ap_done == 1'b0) | (grp_kmp_fu_712_ap_done == 1'b0);
    ap_done_chain[3] <= (grp_kmp_fu_700_ap_done == 1'b0) | (grp_kmp_fu_688_ap_done == 1'b0) | (grp_kmp_fu_676_ap_done == 1'b0) | (grp_kmp_fu_664_ap_done == 1'b0) | (grp_kmp_fu_1420_ap_done == 1'b0) | (grp_kmp_fu_1408_ap_done == 1'b0) | (grp_kmp_fu_1396_ap_done == 1'b0) | (grp_kmp_fu_1384_ap_done == 1'b0);
    ap_done_chain[4] <= (grp_kmp_fu_1372_ap_done == 1'b0) | (grp_kmp_fu_1360_ap_done == 1'b0) | (grp_kmp_fu_1348_ap_done == 1'b0) | (grp_kmp_fu_1336_ap_done == 1'b0) | (grp_kmp_fu_1324_ap_done == 1'b0) | (grp_kmp_fu_1312_ap_done == 1'b0) | (grp_kmp_fu_1300_ap_done == 1'b0) | (grp_kmp_fu_1288_ap_done == 1'b0); 
    ap_done_chain[5] <= (grp_kmp_fu_1276_ap_done == 1'b0) | (grp_kmp_fu_1264_ap_done == 1'b0) | (grp_kmp_fu_1252_ap_done == 1'b0) | (grp_kmp_fu_1240_ap_done == 1'b0) | (grp_kmp_fu_1228_ap_done == 1'b0) | (grp_kmp_fu_1216_ap_done == 1'b0) | (grp_kmp_fu_1204_ap_done == 1'b0) | (grp_kmp_fu_1192_ap_done == 1'b0); 
    ap_done_chain[6] <= (grp_kmp_fu_1180_ap_done == 1'b0) | (grp_kmp_fu_1168_ap_done == 1'b0) | (grp_kmp_fu_1156_ap_done == 1'b0) | (grp_kmp_fu_1144_ap_done == 1'b0) | (grp_kmp_fu_1132_ap_done == 1'b0) | (grp_kmp_fu_1120_ap_done == 1'b0) | (grp_kmp_fu_1108_ap_done == 1'b0) | (grp_kmp_fu_1096_ap_done == 1'b0); 
    ap_done_chain[7] <= (grp_kmp_fu_1084_ap_done == 1'b0) | (grp_kmp_fu_1072_ap_done == 1'b0) | (grp_kmp_fu_1060_ap_done == 1'b0) | (grp_kmp_fu_1048_ap_done == 1'b0) | (grp_kmp_fu_1036_ap_done == 1'b0) | (grp_kmp_fu_1024_ap_done == 1'b0) | (grp_kmp_fu_1012_ap_done == 1'b0) | (grp_kmp_fu_1000_ap_done == 1'b0);
end

always @ (posedge ap_clk) begin
    ap_block_state2_on_subcall_done <= (|ap_done_chain);
end

...
reg    input_stream_0_2_V_V_blk_n;
...
always @ (*) begin
    if (((tmp_i_i_i_reg_195_pp0_iter1_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        input_stream_0_2_V_V_blk_n = input_stream_0_2_V_V_full_n;
    end else begin
        input_stream_0_2_V_V_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_i_i_i_reg_195_pp0_iter1_reg == 1'd1) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
    ...
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (tmp_i_i_i_fu_167_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1)) & ~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (tmp_i_i_i_fu_167_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((m_axi_var_input_0_2_V_RVALID == 1'b0) & (tmp_i_i_i_reg_195 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((input_stream_0_2_V_V_full_n == 1'b0) & (tmp_i_i_i_reg_195_pp0_iter1_reg == 1'd1) & (ap_enable_reg_pp0_iter2 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((m_axi_var_input_0_2_V_RVALID == 1'b0) & (tmp_i_i_i_reg_195 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((input_stream_0_2_V_V_full_n == 1'b0) & (tmp_i_i_i_reg_195_pp0_iter1_reg == 1'd1) & (ap_enable_reg_pp0_iter2 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((m_axi_var_input_0_2_V_RVALID == 1'b0) & (tmp_i_i_i_reg_195 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((input_stream_0_2_V_V_full_n == 1'b0) & (tmp_i_i_i_reg_195_pp0_iter1_reg == 1'd1) & (ap_enable_reg_pp0_iter2 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state130_pp0_stage0_iter2 = ((input_stream_0_2_V_V_full_n == 1'b0) & (tmp_i_i_i_reg_195_pp0_iter1_reg == 1'd1));
end
...
endmodule //jacobi2d_kernel_load40

...
#ifndef _jacobi2d_kernel_load35_HH_
#define _jacobi2d_kernel_load35_HH_
...
struct jacobi2d_kernel_load35 : public sc_module {
    ...
    sc_out< sc_lv<512> > input_stream_0_0_V_V_din;
    sc_in< sc_logic > input_stream_0_0_V_V_full_n;
    sc_out< sc_logic > input_stream_0_0_V_V_write;
    sc_out< sc_logic > m_axi_var_input_0_0_V_AWVALID;
    sc_in< sc_logic > m_axi_var_input_0_0_V_AWREADY;
    sc_out< sc_lv<32> > m_axi_var_input_0_0_V_AWADDR;
    sc_out< sc_lv<1> > m_axi_var_input_0_0_V_AWID;
    sc_out< sc_lv<32> > m_axi_var_input_0_0_V_AWLEN;
    sc_out< sc_lv<3> > m_axi_var_input_0_0_V_AWSIZE;
    sc_out< sc_lv<2> > m_axi_var_input_0_0_V_AWBURST;
    sc_out< sc_lv<2> > m_axi_var_input_0_0_V_AWLOCK;
    sc_out< sc_lv<4> > m_axi_var_input_0_0_V_AWCACHE;
    sc_out< sc_lv<3> > m_axi_var_input_0_0_V_AWPROT;
    sc_out< sc_lv<4> > m_axi_var_input_0_0_V_AWQOS;
    sc_out< sc_lv<4> > m_axi_var_input_0_0_V_AWREGION;
    sc_out< sc_lv<1> > m_axi_var_input_0_0_V_AWUSER;
    sc_out< sc_logic > m_axi_var_input_0_0_V_WVALID;
    sc_in< sc_logic > m_axi_var_input_0_0_V_WREADY;
    sc_out< sc_lv<512> > m_axi_var_input_0_0_V_WDATA;
    sc_out< sc_lv<64> > m_axi_var_input_0_0_V_WSTRB;
    sc_out< sc_logic > m_axi_var_input_0_0_V_WLAST;
    sc_out< sc_lv<1> > m_axi_var_input_0_0_V_WID;
    sc_out< sc_lv<1> > m_axi_var_input_0_0_V_WUSER;
    sc_out< sc_logic > m_axi_var_input_0_0_V_ARVALID;
    sc_in< sc_logic > m_axi_var_input_0_0_V_ARREADY;
    sc_out< sc_lv<32> > m_axi_var_input_0_0_V_ARADDR;
    sc_out< sc_lv<1> > m_axi_var_input_0_0_V_ARID;
    sc_out< sc_lv<32> > m_axi_var_input_0_0_V_ARLEN;
    sc_out< sc_lv<3> > m_axi_var_input_0_0_V_ARSIZE;
    sc_out< sc_lv<2> > m_axi_var_input_0_0_V_ARBURST;
    sc_out< sc_lv<2> > m_axi_var_input_0_0_V_ARLOCK;
    sc_out< sc_lv<4> > m_axi_var_input_0_0_V_ARCACHE;
    sc_out< sc_lv<3> > m_axi_var_input_0_0_V_ARPROT;
    sc_out< sc_lv<4> > m_axi_var_input_0_0_V_ARQOS;
    sc_out< sc_lv<4> > m_axi_var_input_0_0_V_ARREGION;
    sc_out< sc_lv<1> > m_axi_var_input_0_0_V_ARUSER;
    sc_in< sc_logic > m_axi_var_input_0_0_V_RVALID;
    sc_out< sc_logic > m_axi_var_input_0_0_V_RREADY;
    sc_in< sc_lv<512> > m_axi_var_input_0_0_V_RDATA;
    sc_in< sc_logic > m_axi_var_input_0_0_V_RLAST;
    sc_in< sc_lv<1> > m_axi_var_input_0_0_V_RID;
    sc_in< sc_lv<1> > m_axi_var_input_0_0_V_RUSER;
    sc_in< sc_lv<2> > m_axi_var_input_0_0_V_RRESP;
    sc_in< sc_logic > m_axi_var_input_0_0_V_BVALID;
    sc_out< sc_logic > m_axi_var_input_0_0_V_BREADY;
    sc_in< sc_lv<2> > m_axi_var_input_0_0_V_BRESP;
    sc_in< sc_lv<1> > m_axi_var_input_0_0_V_BID;
    sc_in< sc_lv<1> > m_axi_var_input_0_0_V_BUSER;
    sc_in< sc_lv<32> > var_input_0_0_V_offset_dout;
    sc_in< sc_logic > var_input_0_0_V_offset_empty_n;
    sc_out< sc_logic > var_input_0_0_V_offset_read;
    ...
    // Module declarations
    jacobi2d_kernel_load35(sc_module_name name);
    SC_HAS_PROCESS(jacobi2d_kernel_load35);

    ~jacobi2d_kernel_load35();
    ...
    sc_signal< sc_logic > var_input_0_0_V_blk_n_AR;
    sc_signal< sc_logic > ap_CS_fsm_state2;
    sc_signal< sc_logic > var_input_0_0_V_blk_n_R;
    sc_signal< sc_logic > ap_CS_fsm_pp0_stage0;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter1;
    sc_signal< bool > ap_block_pp0_stage0;
    sc_signal< sc_lv<1> > tmp_i_i_i_reg_219;
    sc_signal< sc_logic > var_input_0_0_V_offset_blk_n;
    sc_signal< sc_logic > coalesced_data_num_blk_n;
    sc_signal< sc_logic > coalesced_data_num_out_blk_n;
    sc_signal< sc_lv<31> > i_i_i_i_reg_152;
    sc_signal< sc_lv<26> > var_input_0_0_V_offset1_i_reg_202;
    sc_signal< bool > ap_block_state1;
    sc_signal< sc_lv<32> > tmp_fu_173_p1;
    sc_signal< sc_lv<32> > tmp_reg_207;
    sc_signal< sc_logic > ap_sig_ioackin_m_axi_var_input_0_0_V_ARREADY;
    sc_signal< sc_lv<1> > tmp_i_i_i_fu_191_p2;
    ...
    sc_signal< sc_lv<1> > tmp_i_i_i_reg_219_pp0_iter1_reg;
    sc_signal< sc_lv<31> > i_fu_196_p2;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter0;
    sc_signal< sc_lv<512> > tmp_V_reg_228;
    sc_signal< sc_logic > ap_CS_fsm_state127;
    sc_signal< bool > ap_block_pp0_stage0_subdone;
    sc_signal< sc_logic > ap_condition_pp0_exit_iter0_state128;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter2;
    sc_signal< sc_lv<64> > tmp_i_fu_177_p1;
    sc_signal< sc_logic > ap_reg_ioackin_m_axi_var_input_0_0_V_ARREADY;
    sc_signal< bool > ap_block_pp0_stage0_01001;
    sc_signal< sc_lv<32> > i_cast_i_i_i_fu_187_p1;
    ...
    void thread_ap_sig_ioackin_m_axi_var_input_0_0_V_ARREADY();
    ...
    void thread_i_cast_i_i_i_fu_187_p1();
    void thread_i_fu_196_p2();
    void thread_input_stream_0_0_V_V_din();
    void thread_input_stream_0_0_V_V_write();
    void thread_internal_ap_ready();
    void thread_m_axi_var_input_0_0_V_ARADDR();
    void thread_m_axi_var_input_0_0_V_ARBURST();
    void thread_m_axi_var_input_0_0_V_ARCACHE();
    void thread_m_axi_var_input_0_0_V_ARID();
    void thread_m_axi_var_input_0_0_V_ARLEN();
    void thread_m_axi_var_input_0_0_V_ARLOCK();
    void thread_m_axi_var_input_0_0_V_ARPROT();
    void thread_m_axi_var_input_0_0_V_ARQOS();
    void thread_m_axi_var_input_0_0_V_ARREGION();
    void thread_m_axi_var_input_0_0_V_ARSIZE();
    void thread_m_axi_var_input_0_0_V_ARUSER();
    void thread_m_axi_var_input_0_0_V_ARVALID();
    void thread_m_axi_var_input_0_0_V_AWADDR();
    void thread_m_axi_var_input_0_0_V_AWBURST();
    void thread_m_axi_var_input_0_0_V_AWCACHE();
    void thread_m_axi_var_input_0_0_V_AWID();
    void thread_m_axi_var_input_0_0_V_AWLEN();
    void thread_m_axi_var_input_0_0_V_AWLOCK();
    void thread_m_axi_var_input_0_0_V_AWPROT();
    void thread_m_axi_var_input_0_0_V_AWQOS();
    void thread_m_axi_var_input_0_0_V_AWREGION();
    void thread_m_axi_var_input_0_0_V_AWSIZE();
    void thread_m_axi_var_input_0_0_V_AWUSER();
    void thread_m_axi_var_input_0_0_V_AWVALID();
    void thread_m_axi_var_input_0_0_V_BREADY();
    void thread_m_axi_var_input_0_0_V_RREADY();
    void thread_m_axi_var_input_0_0_V_WDATA();
    void thread_m_axi_var_input_0_0_V_WID();
    void thread_m_axi_var_input_0_0_V_WLAST();
    void thread_m_axi_var_input_0_0_V_WSTRB();
    void thread_m_axi_var_input_0_0_V_WUSER();
    void thread_m_axi_var_input_0_0_V_WVALID();
    void thread_real_start();
    void thread_start_out();
    void thread_start_write();
    void thread_tmp_fu_173_p1();
    void thread_tmp_i_fu_177_p1();
    void thread_tmp_i_i_i_fu_191_p2();
    void thread_var_input_0_0_V_blk_n_AR();
    void thread_var_input_0_0_V_blk_n_R();
    void thread_var_input_0_0_V_offset_blk_n();
    void thread_var_input_0_0_V_offset_read();

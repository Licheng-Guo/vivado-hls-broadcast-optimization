...
#ifndef _jacobi2d_kernel_load37_HH_
#define _jacobi2d_kernel_load37_HH_
...
struct jacobi2d_kernel_load37 : public sc_module {
    ...
    sc_out< sc_lv<512> > input_stream_0_2_V_V_din;
    sc_in< sc_logic > input_stream_0_2_V_V_full_n;
    sc_out< sc_logic > input_stream_0_2_V_V_write;
    sc_out< sc_logic > m_axi_var_input_0_2_V_AWVALID;
    sc_in< sc_logic > m_axi_var_input_0_2_V_AWREADY;
    sc_out< sc_lv<32> > m_axi_var_input_0_2_V_AWADDR;
    sc_out< sc_lv<1> > m_axi_var_input_0_2_V_AWID;
    sc_out< sc_lv<32> > m_axi_var_input_0_2_V_AWLEN;
    sc_out< sc_lv<3> > m_axi_var_input_0_2_V_AWSIZE;
    sc_out< sc_lv<2> > m_axi_var_input_0_2_V_AWBURST;
    sc_out< sc_lv<2> > m_axi_var_input_0_2_V_AWLOCK;
    sc_out< sc_lv<4> > m_axi_var_input_0_2_V_AWCACHE;
    sc_out< sc_lv<3> > m_axi_var_input_0_2_V_AWPROT;
    sc_out< sc_lv<4> > m_axi_var_input_0_2_V_AWQOS;
    sc_out< sc_lv<4> > m_axi_var_input_0_2_V_AWREGION;
    sc_out< sc_lv<1> > m_axi_var_input_0_2_V_AWUSER;
    sc_out< sc_logic > m_axi_var_input_0_2_V_WVALID;
    sc_in< sc_logic > m_axi_var_input_0_2_V_WREADY;
    sc_out< sc_lv<512> > m_axi_var_input_0_2_V_WDATA;
    sc_out< sc_lv<64> > m_axi_var_input_0_2_V_WSTRB;
    sc_out< sc_logic > m_axi_var_input_0_2_V_WLAST;
    sc_out< sc_lv<1> > m_axi_var_input_0_2_V_WID;
    sc_out< sc_lv<1> > m_axi_var_input_0_2_V_WUSER;
    sc_out< sc_logic > m_axi_var_input_0_2_V_ARVALID;
    sc_in< sc_logic > m_axi_var_input_0_2_V_ARREADY;
    sc_out< sc_lv<32> > m_axi_var_input_0_2_V_ARADDR;
    sc_out< sc_lv<1> > m_axi_var_input_0_2_V_ARID;
    sc_out< sc_lv<32> > m_axi_var_input_0_2_V_ARLEN;
    sc_out< sc_lv<3> > m_axi_var_input_0_2_V_ARSIZE;
    sc_out< sc_lv<2> > m_axi_var_input_0_2_V_ARBURST;
    sc_out< sc_lv<2> > m_axi_var_input_0_2_V_ARLOCK;
    sc_out< sc_lv<4> > m_axi_var_input_0_2_V_ARCACHE;
    sc_out< sc_lv<3> > m_axi_var_input_0_2_V_ARPROT;
    sc_out< sc_lv<4> > m_axi_var_input_0_2_V_ARQOS;
    sc_out< sc_lv<4> > m_axi_var_input_0_2_V_ARREGION;
    sc_out< sc_lv<1> > m_axi_var_input_0_2_V_ARUSER;
    sc_in< sc_logic > m_axi_var_input_0_2_V_RVALID;
    sc_out< sc_logic > m_axi_var_input_0_2_V_RREADY;
    sc_in< sc_lv<512> > m_axi_var_input_0_2_V_RDATA;
    sc_in< sc_logic > m_axi_var_input_0_2_V_RLAST;
    sc_in< sc_lv<1> > m_axi_var_input_0_2_V_RID;
    sc_in< sc_lv<1> > m_axi_var_input_0_2_V_RUSER;
    sc_in< sc_lv<2> > m_axi_var_input_0_2_V_RRESP;
    sc_in< sc_logic > m_axi_var_input_0_2_V_BVALID;
    sc_out< sc_logic > m_axi_var_input_0_2_V_BREADY;
    sc_in< sc_lv<2> > m_axi_var_input_0_2_V_BRESP;
    sc_in< sc_lv<1> > m_axi_var_input_0_2_V_BID;
    sc_in< sc_lv<1> > m_axi_var_input_0_2_V_BUSER;
    sc_in< sc_lv<32> > var_input_0_2_V_offset_dout;
    sc_in< sc_logic > var_input_0_2_V_offset_empty_n;
    sc_out< sc_logic > var_input_0_2_V_offset_read;
    ...
    // Module declarations
    jacobi2d_kernel_load37(sc_module_name name);
    SC_HAS_PROCESS(jacobi2d_kernel_load37);

    ~jacobi2d_kernel_load37();
    ...
    sc_signal< sc_logic > var_input_0_2_V_blk_n_AR;
    sc_signal< sc_logic > ap_CS_fsm_state2;
    sc_signal< sc_logic > var_input_0_2_V_blk_n_R;
    sc_signal< sc_logic > ap_CS_fsm_pp0_stage0;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter1;
    sc_signal< bool > ap_block_pp0_stage0;
    sc_signal< sc_lv<1> > tmp_i_i_i_reg_195;
    sc_signal< sc_logic > var_input_0_2_V_offset_blk_n;
    sc_signal< sc_logic > coalesced_data_num_blk_n;
    sc_signal< sc_lv<31> > i_i_i_i_reg_128;
    sc_signal< sc_lv<26> > var_input_0_2_V_offset1_i_reg_178;
    sc_signal< bool > ap_block_state1;
    sc_signal< sc_lv<32> > tmp_fu_149_p1;
    sc_signal< sc_lv<32> > tmp_reg_183;
    sc_signal< sc_logic > ap_sig_ioackin_m_axi_var_input_0_2_V_ARREADY;
    ...
    sc_signal< sc_logic > ap_reg_ioackin_m_axi_var_input_0_2_V_ARREADY;
    ...
    void thread_ap_sig_ioackin_m_axi_var_input_0_2_V_ARREADY();
    ...
    void thread_input_stream_0_2_V_V_din();
    void thread_input_stream_0_2_V_V_write();
    void thread_m_axi_var_input_0_2_V_ARADDR();
    void thread_m_axi_var_input_0_2_V_ARBURST();
    void thread_m_axi_var_input_0_2_V_ARCACHE();
    void thread_m_axi_var_input_0_2_V_ARID();
    void thread_m_axi_var_input_0_2_V_ARLEN();
    void thread_m_axi_var_input_0_2_V_ARLOCK();
    void thread_m_axi_var_input_0_2_V_ARPROT();
    void thread_m_axi_var_input_0_2_V_ARQOS();
    void thread_m_axi_var_input_0_2_V_ARREGION();
    void thread_m_axi_var_input_0_2_V_ARSIZE();
    void thread_m_axi_var_input_0_2_V_ARUSER();
    void thread_m_axi_var_input_0_2_V_ARVALID();
    void thread_m_axi_var_input_0_2_V_AWADDR();
    void thread_m_axi_var_input_0_2_V_AWBURST();
    void thread_m_axi_var_input_0_2_V_AWCACHE();
    void thread_m_axi_var_input_0_2_V_AWID();
    void thread_m_axi_var_input_0_2_V_AWLEN();
    void thread_m_axi_var_input_0_2_V_AWLOCK();
    void thread_m_axi_var_input_0_2_V_AWPROT();
    void thread_m_axi_var_input_0_2_V_AWQOS();
    void thread_m_axi_var_input_0_2_V_AWREGION();
    void thread_m_axi_var_input_0_2_V_AWSIZE();
    void thread_m_axi_var_input_0_2_V_AWUSER();
    void thread_m_axi_var_input_0_2_V_AWVALID();
    void thread_m_axi_var_input_0_2_V_BREADY();
    void thread_m_axi_var_input_0_2_V_RREADY();
    void thread_m_axi_var_input_0_2_V_WDATA();
    void thread_m_axi_var_input_0_2_V_WID();
    void thread_m_axi_var_input_0_2_V_WLAST();
    void thread_m_axi_var_input_0_2_V_WSTRB();
    void thread_m_axi_var_input_0_2_V_WUSER();
    void thread_m_axi_var_input_0_2_V_WVALID();
    void thread_tmp_fu_149_p1();
    void thread_tmp_i_fu_153_p1();
    void thread_tmp_i_i_i_fu_167_p2();
    void thread_var_input_0_2_V_blk_n_AR();
    void thread_var_input_0_2_V_blk_n_R();
    void thread_var_input_0_2_V_offset_blk_n();
    void thread_var_input_0_2_V_offset_read();
